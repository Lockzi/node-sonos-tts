...
function HttpAPI(discovery, port, presets) {
  ...
  function restorePlayer(coordinatorUUID, uuid, backup, callback) {
  ...
  function restoreSonos(callback) {
    ...
    coordinatorState.forEach(function (coordinator) {
      ...
      asyncSeries.push(function (callback) {
        restorePlayer(playerCoordinator.uuid, playerCoordinator.uuid, coordinatorBackedUp, function (success) {
          callback(success);
        });
      });
      ...
      coordinator.members.forEach(function (member) {
        ...
        asyncSeries.push(function (callback) {
          restorePlayer(playerCoordinator.uuid, player.uuid, member.state, function (success) {
            callback(success);
          });
        });
